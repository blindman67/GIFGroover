...
Here are some examples of GIFGroover in action.

Creating a gif player using GIFGroover at codePen
...
Or use the module form and simply import to your script.

    import GIFGroover from "./GIFGroover-module.js";
